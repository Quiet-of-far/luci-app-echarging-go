...
function action_status()
	render_command("/usr/bin/echarging -config /var/etc/echarging.json status", true)
end

function action_query_now()
	render_command("/usr/bin/echarging -config /var/etc/echarging.json query-now", true)
end

function action_test_email()
	render_command("/usr/bin/echarging -config /var/etc/echarging.json test-notify", true)
end
